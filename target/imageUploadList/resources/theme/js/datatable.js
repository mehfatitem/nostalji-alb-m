...
function getArrayLength(){
	arrayLength = 0;
	$("table.dataTable tbody th.dt-body-center, table.dataTable tbody td.dt-body-center").each(function(){
				...
				function() {
					...
					$("#deleteOperation").click(function(){
						if(selectedArray.length == 0){
							sweetAlert("Uyarı!", "Lütfen seçim yapınız!", "warning");
						}else{
							var imgIds = selectedArray.toString();
							for(var i in selectedArray){
								selectedName[i] = $("#"+selectedArray[i]).text();
							}
							var imgNames = selectedName.toString();
							console.log(imgIds  + " " + imgNames);
							swal(
									{
										title : "Uyarı !",
													...
													.ajax({
														...
														success : function(data) {
															if (data == "1") {
																...
																console.log(length);
																/*if(length == selectedArray.length && length == 0){
